...
We now want to show that a maximally symmetric space really possesses the maximum number of symmetry, namely the maximum number of independent Killing vectors.
